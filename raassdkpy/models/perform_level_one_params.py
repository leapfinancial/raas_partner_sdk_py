...
class PerformLevelOneParams(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addressDescription", "countryCode", "callLocationLongitude", "callLocationLatitude", "city", "birthState", "state", "zipCode", "gender", "placeDetail", "address2", "address1", "dateOfBirth", "email", "secondLastName", "middleName", "lastName", "firstName"]
