...
class TemplateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemplateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemplateRequest:
        """Create an instance of TemplateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TemplateRequest.parse_obj(obj)

        _obj = TemplateRequest.parse_obj({
