...
class RaasPreQuoteValues(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, exchange_rate, source_fee, transaction_fee, destination_fee, tenant_fee, type, *args, **kwargs):  # noqa: E501
        """RaasPreQuoteValues - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, exchange_rate, source_fee, transaction_fee, destination_fee, tenant_fee, type, *args, **kwargs):  # noqa: E501
        """RaasPreQuoteValues - a model defined in OpenAPI
