...
class AddCardSessionParams(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, cardtype, number, name_on_card, expiration_date, card_network, *args, **kwargs):  # noqa: E501
        """AddCardSessionParams - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, cardtype, number, name_on_card, expiration_date, card_network, *args, **kwargs):  # noqa: E501
        """AddCardSessionParams - a model defined in OpenAPI
