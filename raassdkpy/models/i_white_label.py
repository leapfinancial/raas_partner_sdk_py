...
class IWhiteLabel(BaseModel):
    ...
    __properties = ["id", "primaryColor", "secondaryColor", "thirdColor", "surfaceColor", "fullLogoUrl", "smallLogoUrl", "whiteLogoUrl", "fontFamily", "colorGradient", "gradientIcon", "gradientText", "gradientButton", "gradientLogo", "welcomeFootMessage", "appName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IWhiteLabel:
        """Create an instance of IWhiteLabel from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IWhiteLabel:
        """Create an instance of IWhiteLabel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IWhiteLabel.parse_obj(obj)

        _obj = IWhiteLabel.parse_obj({
            "id": obj.get("id"),
