...
class SourceOfFunding(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "isPrimary", "accountNumber", "bankEntityNumber", "type", "expirationDate", "expirationMonth", "expirationYear", "cardType", "number", "name", "tokenData", "cardNetwork", "currency"]
