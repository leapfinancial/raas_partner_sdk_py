...
class SourceOfFunding(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, account_number, bank_entity_number, type, expiration_date, expiration_month, expiration_year, card_type, number, token_data, *args, **kwargs):  # noqa: E501
        """SourceOfFunding - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            is_primary (bool): Subscriber's main source of funding. [optional]  # noqa: E501
            name (str): Credit/Debit card holder name. Account name.. [optional]  # noqa: E501
        ...
        self.bank_entity_number = bank_entity_number
        self.type = type
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_number, bank_entity_number, type, expiration_date, expiration_month, expiration_year, card_type, number, token_data, *args, **kwargs):  # noqa: E501
        """SourceOfFunding - a model defined in OpenAPI
