...
class QuoteTransactionBase(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["senderUserId", "senderCountryCode", "recipientUserId", "recipientCountryCode", "recipientCurrency", "recipientAmount", "isSenderAmount", "amountCurrency", "amount", "operationType", "sourcePaymentMethod", "destinationPaymentMethod", "tennantFee"]
