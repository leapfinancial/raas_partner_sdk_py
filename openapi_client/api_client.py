...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = FileApi()
        api_instance.upload_documents  # this is an instance of the class Endpoint
        api_instance.upload_documents()  # this invokes api_instance.upload_documents.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.upload_documents.callable or self.callable in this class
