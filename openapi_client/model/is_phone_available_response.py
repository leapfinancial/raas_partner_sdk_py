...
class IsPhoneAvailableResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, available, verified, has_pincode, *args, **kwargs):  # noqa: E501
        """IsPhoneAvailableResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, available, verified, has_pincode, *args, **kwargs):  # noqa: E501
        """IsPhoneAvailableResponse - a model defined in OpenAPI
