...
class RequestMoneyBase(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, correlation_id, destination_payment_method, reason, recipient_amount, recipient_currency, *args, **kwargs):  # noqa: E501
        """RequestMoneyBase - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, correlation_id, destination_payment_method, reason, recipient_amount, recipient_currency, *args, **kwargs):  # noqa: E501
        """RequestMoneyBase - a model defined in OpenAPI
