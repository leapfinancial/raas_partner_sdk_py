...
class MapEntry(BaseModel):
    ...
    translate: Optional[Dict[str, StrictStr]] = None
    __properties = ["fieldName", "translate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MapEntry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MapEntry:
        """Create an instance of MapEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MapEntry.parse_obj(obj)

        _obj = MapEntry.parse_obj({
