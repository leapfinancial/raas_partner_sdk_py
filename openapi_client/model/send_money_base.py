...
class SendMoneyBase(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, correlation_id, source_payment_method, amount, currency, sender_amount, sender_currency, recipient_amount, recipient_currency, fee_type, source_fee, transaction_fee, destination_fee, exchange_rate, call_location_longitude, call_location_latitude, *args, **kwargs):  # noqa: E501
        """SendMoneyBase - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, correlation_id, source_payment_method, amount, currency, sender_amount, sender_currency, recipient_amount, recipient_currency, fee_type, source_fee, transaction_fee, destination_fee, exchange_rate, call_location_longitude, call_location_latitude, *args, **kwargs):  # noqa: E501
        """SendMoneyBase - a model defined in OpenAPI
