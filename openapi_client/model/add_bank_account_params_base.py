...
class AddBankAccountParamsBase(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, account_number, bank_account_type, bank_entity_number, is_primary, country, *args, **kwargs):  # noqa: E501
        """AddBankAccountParamsBase - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, account_number, bank_account_type, bank_entity_number, is_primary, country, *args, **kwargs):  # noqa: E501
        """AddBankAccountParamsBase - a model defined in OpenAPI
