...
class AddCardPartnerParams(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, cardtype, number, is_primary, name_on_card, expiration_date, country, card_network, *args, **kwargs):  # noqa: E501
        """AddCardPartnerParams - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, cardtype, number, is_primary, name_on_card, expiration_date, country, card_network, *args, **kwargs):  # noqa: E501
        """AddCardPartnerParams - a model defined in OpenAPI
