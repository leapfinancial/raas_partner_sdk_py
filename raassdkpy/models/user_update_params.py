...
class UserUpdateParams(BaseModel):
    ...
    __properties = ["email", "firstName", "lastName", "middleName", "secondLastName", "address1", "address2", "placeId", "country", "gender", "dob", "country_id", "status", "firstTime", "zip", "placeDetail", "latitude", "longitude", "addressDescription", "customCountryCode", "facebookPublicUserName", "instagramPublicUserName", "state", "city", "birthState", "accountCode"]
